...
if __name__ == "__main__":
    ...
    clf=joblib.load('MultiOutputRegressorbkp.pkl')
    C= Client()
    initialize_car(C)
    for step in xrange(C.maxSteps,0,-1):
        ...
        arra=clf.predict(a)
        drive_example(C,arra)
        d=C.respond_to_server()
    C.shutdown()
